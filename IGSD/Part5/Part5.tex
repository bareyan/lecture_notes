...
\begin{figure}[H]
\centering
% Placeholder: Ideally show two images, one aliased, one antialiased
\fbox{Image: Comparaison Crénelage vs Anticrénelage}
...
\begin{figure}[H]
\centering
% Placeholder: Ideally show three images: no AA, supersampling AA, distance AA
\fbox{Image: Comparaison des Résultats d'Anticrénelage}
